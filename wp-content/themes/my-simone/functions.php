...
function my_simone_widgets_init() {
	...
	register_sidebar( array(
		...
		'description'   => __('Footer Widgets area appears in the footer of the siter', 'my-simone' ),
		'id'            => 'sidebar-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
...
function my_simone_scripts() {
    ...
    wp_enqueue_script( 'my-simone-superfish', get_template_directory_uri() . '/js/superfish.js', array('jquery'), '20140917', true );
    
    wp_enqueue_script( 'my-simone-superfish-settings', get_template_directory_uri() . '/js/superfishSettings.js', array('my-simone-superfish'), '20140917', true );
                
    wp_enqueue_script( 'my-simone-hide-search', get_template_directory_uri() . '/js/hideSearch.js', array('jquery'), '20140917', true );
                
	wp_enqueue_script( 'my-simone-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
	
	wp_enqueue_script( 'my-simone-masonry', get_template_directory_uri() . '/js/masonrySettings.js', array('masonry'), '20140918', true );
